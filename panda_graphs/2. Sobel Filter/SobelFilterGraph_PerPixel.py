...
df = pd.read_csv('panda_graphs/0. All CSV Files for Graphs/image_processing_times_SobelFilter_all_res.csv')
...
plt.title('Sobel Filter - Time Taken to Apply Filter to a Single Pixel for JS and WASM', fontsize=16)
